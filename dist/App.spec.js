...
// A few tests
describe('GET /list', () => {
    it('Responds with a list of all existing records', () => supertest(App_1.default)
        .get('/list')
...
describe('GET /count', () => {
    it('Responds with a count of records (38)', () => supertest(App_1.default)
        .get('/count')
        .expect('Content-Type', /json/)
        .expect(200)
        .expect((response) => {
...
describe('GET /search', () => {
    it('Finds a specific record with the specified parameters', () => supertest(App_1.default)
...
describe('GET /stats', () => {
    it('Returns statistics', () => supertest(App_1.default)
        .get('/stats')
        .expect('Content-Type', /json/)
        .expect(200)
        .expect((response) => {
