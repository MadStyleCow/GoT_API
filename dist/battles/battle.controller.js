...
const battle_model_1 = require("./battle.model");
const Battle = mongoose.model('Battle', battle_model_1.BattleSchema, 'Battle');
// Class body
        ...
        */
        ...
        Promise.all(promiseArray)
            ...
            const compositeObject = {
                ...
                'defender_size': {
                    'average': Math.floor(defenderSize.average),
